...
import group20 from './imgs/Group 20.png'
import Upcoming from './Upcoming'
export default function CalPage() {
    const [cnt,setCnt] = useState(0);
    const up = <Upcoming onClick =  {() => {setCnt(1)}}/>
    const add = <AddEvent onClick = {()=> {setCnt(0)}}/>
  return (
	          <>
            <div className="flex items-center justify-center w-screen h-screen dark:bg-primary">
                <div className="2xl:w-1/3 xl:w-1/2 lg:w-3/5 sm:w-4/5 w-full h-full shadow-lg">
                    <div className="md:p-16 md:pb-12 p-5 dark:bg-primary bg-white rounded-t">
                        <div className="px-4 flex items-center justify-between">
                            <h1 className="text-2xl font-bold dark:text-gray-100 text-gray-800">March 2022</h1>
					...
					<td>
                                            <div className="px-4 py-4 cursor-pointer flex w-full justify-center">
                                                <p className="text-2xl text-gray-500 dark:text-gray-100 font-medium">31</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
